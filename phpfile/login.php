...
<head>
    ...
    <style>
	 body {
            background: #7f9b4e url(component/img/.jpg) no-repeat center top;
...
<body>
 <div>
  ...
  <source src="component/img/bg4.mp4" type="video/mp4">
</video>
</div>
    <div id="section3">
			                            ...
			                            <div class="form-bottom">
						                    <form role="form" action="signup1.php" method="post" class="registration-form">
						                        ...
						                        <div class="form-group">
						                        	...
						                        	<textarea name="details" placeholder="Please fill detail about your" 
